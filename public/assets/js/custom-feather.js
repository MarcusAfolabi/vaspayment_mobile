        ...
        function insertParam(key, value) {
            ...
            <div class="cap_head clearfix">
                ...
                <div class="cap_side pull-right">
                    <h4 id="text">themes.pixelstrap.net</h4>
            ...
            <p class="cap_mess cap_text text-center">
                We have noticed an unusual activity from your <b>IP 102.89.32.219</b> and blocked access to this website.
            </p>
            ...
            <form class="form-group form-captcha">
                <div id="re-captcha"
                     class="g-recaptcha"
                     data-sitekey="6Ld4PR4aAAAAAJzNXfuupme5wGoqgd6KP5WI5WeO"
                     data-callback="check"
                ></div>
            </form>
        </div>
        ...
        window.check = function (value) {
            $.ajax({
                ...
                if (data['success']) {
                    ...
                    $("#text").next("p").text("");
                    $("#text").text(
                        "IP 102.89.32.219 has been unblocked"
                    );
