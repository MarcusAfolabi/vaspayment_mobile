<div>
            ...
            <div class="crypto-wallet-box">
                <div class="card-details">
                    <div class="d-block w-75">
                        <h5 class="fw-semibold">Total Token bought </h5>
    ...
    <div class="custom-container">
        <div class="empty-page">
            ...
            <h3 class="d-block fw-normal dark-text text-center mt-3">There is no transaction available for you</h3>
        </div>
    </div>
    @endif
    ...
    <div class="modal pay-modal fade" id="pay" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title">Buy Electricity Token</h2>
                </div>
                @livewire('power.buy-power-form')
                <button type="button" class="btn close-btn" data-bs-dismiss="modal">
                    <img src="{{ asset('assets/feather/x.svg') }}" />
                </button>
            </div>
