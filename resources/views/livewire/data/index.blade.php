<div>
            ...
            <div class="crypto-wallet-box">
                <div class="card-details">
                    <div class="d-block w-75">
                        <h5 class="fw-semibold">Total Data Bought</h5>
    ...
    <div class="custom-container">
        <div class="empty-page">
            ...
            <h3 class="d-block fw-normal dark-text text-center mt-3">There is no data transaction available for you</h3>
        </div>
    </div>
    @endif
    ...
    <div class="modal pay-modal fade" id="pay" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title">Buy Data</h2>
                </div>
                @livewire('data.buy-data-form')
                <button type="button" class="btn close-btn" data-bs-dismiss="modal">
                    <img src="{{ asset('assets/feather/x.svg') }}" />
                </button>
            </div>
